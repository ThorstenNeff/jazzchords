    ...
    private fun calculateCShapeDim7Chords(): List<Chord> {
        ...
        for (i in 1 until maxFretNumber) {
            ...
            if (aNote != null && eNote != null && cNote != null && gNote != null) {
                ...
                chordList.add(Chord(
                    notes = notes,
                    name = cNote.name + "dim7",
                    flatName = cNote.flatName + "dim7",
                    shape = "C"))
            }
        }
        return chordList
    ...
    private fun calculateAShapeDim7Chords(): List<Chord> {
        ...
        for (i in 1 until maxFretNumber) {
            ...
            if (aNote != null && eNote != null && cNote != null && gNote != null) {
                ...
                chordList.add(Chord(
                    notes = notes,
                    name = aNote.name + "dim7",
                    flatName = aNote.flatName + "dim7",
                    shape = "A"))
            }
        }
        return chordList
    ...
    private fun calculateEShapeDim7Chords(): List<Chord> {
        ...
        for (i in 0 until maxFretNumber) {
            ...
            if (aNote != null && eNote != null && cNote != null && gNote != null) {
                ...
                chordList.add(Chord(
                    notes = notes,
                    name = eNote.name + "dim7",
                    flatName = eNote.flatName + "dim7",
                    shape = "E"))
            }
        }
        return chordList
    ...
    private fun calculateGShapeDim7Chords(): List<Chord> {
        ...
        for (i in 0 until maxFretNumber) {
            ...
            if (aNote != null && eNote != null && cNote != null && gNote != null) {
                ...
                chordList.add(Chord(
                    notes = notes,
                    name = gNote.name + "dim7",
                    flatName = gNote.flatName + "dim7",
                    shape = "G"))
            }
        }
        return chordList
